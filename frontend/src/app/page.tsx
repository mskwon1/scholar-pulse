...
import { ArrowRight, Zap, Shield, Search, BookOpen, Mail } from "lucide-react";
    ...
    <div className="flex flex-col min-h-screen bg-background text-foreground dark">
      ...
      <header className="px-4 lg:px-6 h-14 flex items-center border-b border-border bg-card/60 backdrop-blur-md sticky top-0 z-50">
        <Link className="flex items-center justify-center gap-2" href="#">
          <Image src="/logo.png" alt="Scholar Pulse Logo" width={28} height={28} className="rounded-sm shadow-sm" />
          <span className="font-extrabold tracking-tight text-lg text-primary">Scholar Pulse</span>
        </Link>
            ...
            <div className="flex flex-col items-center space-y-4">
              <div className="space-y-4 mb-4">
                <h1 className="text-4xl font-extrabold tracking-tighter sm:text-5xl md:text-6xl lg:text-7xl">
                  <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-indigo-400">Never Miss a Breakthrough.</span>
                </h1>
                <p className="mx-auto max-w-[700px] text-muted-foreground md:text-xl leading-relaxed">
                  The AI-powered research assistant that scans top journals and pre-prints daily. 
                  Let Gemini summarize the signal, while you focus on the science.
                </p>
              </div>
        ...
        <section className="w-full py-16 md:py-24 bg-background">
          <div className="container px-4 md:px-6 mx-auto">
            <div className="flex flex-col items-center justify-center text-center space-y-4 mb-16">
              ...
              <p className="max-w-[600px] text-muted-foreground md:text-lg">Set it up once, get insights forever.</p>
            </div>
            <div className="grid gap-8 sm:grid-cols-3 max-w-5xl mx-auto">
              <div className="flex flex-col items-center text-center space-y-4 relative">
                ...
                <p className="text-sm text-muted-foreground">Type natural language or select preset keywords that match your exact research interests.</p>
              </div>
              <div className="flex flex-col items-center text-center space-y-4 relative">
                ...
                <p className="text-sm text-muted-foreground">Our Gemini-powered engine scans S2 and arXiv, filtering by SJR Q1/Q2 rank to find top-tier papers.</p>
              </div>
              <div className="flex flex-col items-center text-center space-y-4 relative">
                <div className="hidden sm:block absolute top-10 -right-16 w-32 border-t-2 border-dashed border-border" />
                <div className="bg-primary/10 p-5 rounded-full text-primary">
                ...
                <p className="text-sm text-muted-foreground">Wake up to a beautifully formatted daily email with 3-line bullet summaries at 9:00 AM KST.</p>
              </div>
            </div>
          </div>
        </section>
